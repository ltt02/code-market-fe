        ...
        <div class="overflow-hidden bg-gradient-to-r from-gray-900 to-gray-800 w-64 space-y-6 px-2 py-4 absolute inset-y-0 left-0 md:relative md:-translate-x-0 transform -translate-x-full transition duration-200 ease-in-out"
            ...
            <div class="text-gray-100 text-xl">
                <div @click="clickPersonalInfo()"
                    ...
                    {{ developerInfo && developerInfo.userName ? developerInfo.userName : 'Chưa cập nhật!' }}
                </div>
        ...
        <div class="flex-1 overflow-hidden">
            ...
            <div class="grid justify-items-stretch bg-gradient-to-r from-gray-900 to-gray-800 shadow px-2 py-4">
                <div class="flex justify-between items-center">
                    ...
                    <div class="font-bold text-4xl text-white">TRANG QUẢN LÝ CỦA NHÀ PHÁT TRIỂN
                    </div>
                    <div></div>
                </div>
            </div>
...
import PersonalInformation from '@/components/developer/PersonalInformation.vue';
import StaffManagement from '@/components/developer/StaffManagement.vue';
import Statistic from '@/components/developer/Statistic.vue';
...
onBeforeMount(() => {
    ...
    if (storedAccount) {
        ...
        if (developerInfo.value) {
            fetchUserInfo(developerInfo.value.userName);
