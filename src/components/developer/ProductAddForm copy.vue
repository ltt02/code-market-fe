<template>
    <Dialog v-model:visible="visible" modal header="Xác nhận" :style="{ width: '25rem' }">
        ...
        <div class="flex justify-end gap-2">
            ...
            <Button type="button" label="Có" @click="addApplication"></Button>
        </div>
    </Dialog>
    <div class="alerts">
        ...
        <div class="container flex justify-center items-center" :class="{ 'max-w-full': !props.isShowSidebar }">
            <div class="product-form-container custom-scrollbar">
                ...
                <div>
                    <div id="customer-info-block">
                        <div class="grid-view">
                            <div class="grid-column">
                                ...
                                <InputText v-model="applicationForAdding.name" type="text" name="productName"
                                    placeholder=""
                                ...
                                <Message v-if="!firstTimeOpenForm && !applicationForAdding.name" severity="error"
                        ...
                        <div class="grid-view">
                            <div class="grid-column six-twelfths">
                                ...
                                <Message v-if="!firstTimeOpenForm && applicationForAdding.price <= 0" severity="error"
                                    size="small" variant="simple">
                            ...
                            <div class="grid-column six-twelfths">
                                ...
                                <InputNumber v-model="applicationForAdding.salePercent" inputId="integeronly" fluid />
                                <Message
                                    v-if="!firstTimeOpenForm && applicationForAdding.salePercent < 0 || applicationForAdding.salePercent === null"
                                    severity="error" size="small" variant="simple">
                                    Phần trăm giảm giá phải lớn hơn hoặc bằng 0
                                </Message>
                                <Message v-if="!firstTimeOpenForm && applicationForAdding.salePercent > 100"
                                    severity="error" size="small" variant="simple">
                        ...
                        <div class="grid-view">
                            <div class="grid-column">
                                ...
                                <Message v-if="!firstTimeOpenForm && !selectedSource" severity="error" size="small"
                                    variant="simple">
                        ...
                        <div class="grid-view">
                            <div class="grid-column">
                                ...
                                <Message v-if="!firstTimeOpenForm && thumbnailList.length < 6" severity="error"
                                    size="small" variant="simple">
                                    Bạn cần thêm ít nhất 6 hình ảnh minh họa
                                </Message>
                            </div>
                        </div>
                        <div class="grid-view">
                            <div class="grid-column six-twelfths">
                                ...
                                <Message v-if="!firstTimeOpenForm && selectedFrameworkOptionList.length <= 0"
                                    severity="error" size="small" variant="simple">
                            ...
                            <div class="grid-column six-twelfths">
                                ...
                                <MultiSelect v-model="selectedCategoryOptionList" :options="categoryList"
                                    ...
                                    class="w-full font-medium" overlayClass="custom-scrollbar"
                                    emptyFilterMessage="Không tìm thấy!" selectionMessage="abc" display="chip" />
                                <Message v-if="!firstTimeOpenForm && selectedCategoryOptionList.length <= 0"
                                    severity="error" size="small" variant="simple">
                        ...
                        <div class="grid-view">
                            <div class="grid-column six-twelfths">
                                ...
                                <Message v-if="!firstTimeOpenForm && selectedTypeOption.id == 0" severity="error"
                                    size="small" variant="simple">
                            ...
                            <div class="grid-column six-twelfths">
                                ...
                                <MultiSelect v-model="selectedPlatformOptionList" :options="platformList"
                                    ...
                                    class="w-full font-medium" overlayClass="custom-scrollbar"
                                    emptyFilterMessage="Không tìm thấy!" selectionMessage="abc" display="chip" />
                                <Message v-if="!firstTimeOpenForm && selectedPlatformOptionList.length <= 0"
                                    severity="error" size="small" variant="simple">
                        ...
                        <div class="grid-view">
                            <div class="grid-column">
                                ...
                                <Message v-if="!firstTimeOpenForm && !applicationForAdding.description" severity="error"
                                    size="small" variant="simple">
                    ...
                    <button v-if="productStore.isShowAddFormClick" @click.prevent="openDialog"
...
const onFileSelect = (event) => {
    ...
    applicationForAdding.value.sourceCode = event.files[0];
};

const openDialog = () => {
    if (!applicationForAdding.value.name
        || applicationForAdding.value.price <= 0
        || applicationForAdding.value.salePercent < 0 || applicationForAdding.value.salePercent === null
        || applicationForAdding.value.salePercent > 100
        || !selectedSource
        || thumbnailList.value.length < 6
        ...
        || !applicationForAdding.value.description) {
...
const handleImagesInputChange = async (event) => {
    ...
    for (let i = nextImgIndex.value; i < files.length; i++) {
        ...
        applicationForAdding.value.images.push(files[i]);
        nextImgIndex.value++;
    }
};
